    ...
    <Flex className="m-4 mx-3 small:mx-8 overflow-hidden flex flex-col gap-6">
      ...
      <Flex className="relative">
        <div className="top-0 p-4 hidden small:block absolute w-full">
          <Heading
            style={{ lineHeight: "1" }}
            className="small:text-bigClamp small:text-start text-smallClamp text-center tracking-tight font-bold text-[rgb(250,250,250)] subpixel-antialiased drop-shadow-[0_1.2px_1.2px_rgba(0,0,50,0.4)] text-pretty"
          >
